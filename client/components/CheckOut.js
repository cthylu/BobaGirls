...
class CheckOut extends React.Component {
    ...
    handleSubmit(e){
        ...
        this.setState(this.state = { firstname: "", lastname: "",address: "", city: "", state:"", zipcode: ""}) 
    } 
    render(){
        ...
        <input  name="firstname"  onChange={checkout}  value={firstname}  placeholder="First Name"  required/>< br />
  
        <label htmlFor="lastname"> Last Name*: </label>
        <input  name="lastname"  onChange={checkout}  value={lastname}  placeholder="Last Name"  required/><br />
